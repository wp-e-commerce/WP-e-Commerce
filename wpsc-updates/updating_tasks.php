...
add_option('wpsc_email_receipt', '', __('Thank you for purchasing with %shop_name%! Any items to be shipped will be processed as soon as possible. Any digital items can be downloaded using the links on this page. All prices include tax, postage, and packaging where applicable. You ordered these items:%product_list%%total_shipping%%total_price%', 'wp-e-commerce'), 'yes');
