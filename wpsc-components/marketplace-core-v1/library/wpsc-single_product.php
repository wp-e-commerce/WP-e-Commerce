...
<script type="text/javascript">
	jQuery(document).ready(function($){
		$("form.product_form, .wpsc-add-to-cart-button-form").die( 'submit' );
	})
</script>
...
<?php
		...
		while ( wpsc_have_products() ) : wpsc_the_product(); ?>
					...
					<div class="productcol">
						 ...
						 */
						?>
						<form class="product_form" enctype="multipart/form-data" action="<?php echo esc_url( get_option( 'shopping_cart_url' ) ); ?>" method="post" name="1" id="product_<?php echo wpsc_the_product_id(); ?>">
