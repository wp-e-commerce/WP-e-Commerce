...
<?php
	...
	public function scripts() {
		...
		wp_enqueue_script( 'pro-pay_payos', 'https://gwapi.'.$js.'securenet.com/v1/PayOS.js', 'jquery', false, true );
	}
	...
	public function te_v1_insert_hidden_field() {
		echo '<input type="hidden" id="pro-pay_pay_token" name="pro-pay_pay_token" value="" />';
	}
