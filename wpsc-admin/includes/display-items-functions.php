 ...
 *
 * @param  integer	$post_id		the post ID of the product
 ...
 * @return void
 */
function wpsc_new_gallery_save( $post_id = 0 ) {
	...
	do_action( 'wpsc_after_gallery_save', $post_id, $image_ids );

}

add_action ( 'save_post', 'wpsc_new_gallery_save' );
